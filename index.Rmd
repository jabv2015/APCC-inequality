...
### Spatial distribution of incivilities:<br>Rate per 1000 inhabitants (2006 vs 2017)
...
class: center
name: cormat3
### Appendix 1: Summary Statistics Explanatory Variables
![](images/controls_sum.png)

---
class: center
name: cormat3
### Appendix 2: Correlation Matrix Explanatory Variables
![](images/cormat3.png)

---
class: center
### Appendix 3: Evolution annual count of incivilities <br>and average county rate of incivilities per 1000 inhabitants

<img src="images/fig8.png" alt="drawing" width="7000"/>

---
class: center
### Appendix 4: Spatial distribution of incivilities by category<br> (Average rate per 1000 inhabitants 2006-09-11-13-15-17)

![](images/fig12.png)

---
class: center
### Appendix [5](#poisson): Interpreting coefficients Poisson (NB) Regression:
...
name: nb
class: center
### Appendix 6: [Negative Binomial](#poisson) Regression
